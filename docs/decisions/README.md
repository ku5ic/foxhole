...
| [ADR-010](ADR-010.md) | Scoring model: severity-weighted exponential decay                                              | Accepted                                                                                                                                     |
| [ADR-011](ADR-011.md) | Framework bundle classification: measure execution cost, surface actionability separately       | Accepted                                                                                                                                     |
