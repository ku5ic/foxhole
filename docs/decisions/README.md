...
| ADR                   | Title                                                          | Status                                                                                       |
| --------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [ADR-001](ADR-001.md) | Use axe-core and Lighthouse as complementary audit engines     | Accepted                                                                                     |
| [ADR-002](ADR-002.md) | Finding normalization schema and stable ID format              | Superseded by docs/spec/schemas.md sections 1.3, 2 and docs/spec/architecture.md section 5.3 |
